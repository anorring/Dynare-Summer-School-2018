...
erase_compiled_function('rbc_unexpected_static');
erase_compiled_function('rbc_unexpected_dynamic');
M_.orig_eq_nbr = 6;
M_.eq_nbr = 6;
M_.ramsey_eq_nbr = 0;
...
struct('exo_det',0,'exo_id',1,'multiplicative',0,'periods',5:5,'value',(-0.1)) ];
M_.det_shocks = [ M_.det_shocks;
struct('exo_det',0,'exo_id',1,'multiplicative',0,'periods',15:15,'value',(-0.1)) ];
M_.exo_det_length = 0;
options_.periods = 300;
perfect_foresight_setup;
perfect_foresight_solver;
oo_.exo_simul(11, 1) = 0.1; 
saved_endo = oo_.endo_simul(:, 1:9); 
saved_exo = oo_.exo_simul(1:9, :);
oo_.endo_simul = oo_.endo_simul(:, 10:end); 
oo_.exo_simul = oo_.exo_simul(10:end, :);
options_.periods = 291;
perfect_foresight_solver;
oo_.endo_simul = [ saved_endo oo_.endo_simul ];
oo_.exo_simul = [ saved_exo; oo_.exo_simul ];
var_list_ = char('epsilon');
rplot(var_list_);
var_list_ = char('c');
rplot(var_list_);
save('rbc_unexpected_results.mat', 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save('rbc_unexpected_results.mat', 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save('rbc_unexpected_results.mat', 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save('rbc_unexpected_results.mat', 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save('rbc_unexpected_results.mat', 'estimation_info', '-append');
end
if exist('dataset_info', 'var') == 1
  save('rbc_unexpected_results.mat', 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save('rbc_unexpected_results.mat', 'oo_recursive_', '-append');
end
