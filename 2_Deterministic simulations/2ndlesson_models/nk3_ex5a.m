...
erase_compiled_function('nk3_ex5a_static');
erase_compiled_function('nk3_ex5a_dynamic');
M_.orig_eq_nbr = 5;
M_.eq_nbr = 5;
M_.ramsey_eq_nbr = 0;
...
M_.det_shocks = [ M_.det_shocks;
struct('exo_det',0,'exo_id',2,'multiplicative',0,'periods',5:5,'value',(-0.08)) ];
M_.exo_det_length = 0;
steady;
...
var_list_ = char('r');
rplot(var_list_);
save('nk3_ex5a_results.mat', 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save('nk3_ex5a_results.mat', 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save('nk3_ex5a_results.mat', 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save('nk3_ex5a_results.mat', 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save('nk3_ex5a_results.mat', 'estimation_info', '-append');
end
if exist('dataset_info', 'var') == 1
  save('nk3_ex5a_results.mat', 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save('nk3_ex5a_results.mat', 'oo_recursive_', '-append');
end
