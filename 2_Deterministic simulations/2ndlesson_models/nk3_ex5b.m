...
erase_compiled_function('nk3_ex5b_static');
erase_compiled_function('nk3_ex5b_dynamic');
M_.orig_eq_nbr = 5;
M_.eq_nbr = 5;
M_.ramsey_eq_nbr = 0;
...
oo_.exo_simul(6, 2) = -0.08; 
saved_endo = oo_.endo_simul(:, 1:4);  
saved_exo = oo_.exo_simul(1:4, :);
oo_.endo_simul = oo_.endo_simul(:, 5:end); 
...
var_list_ = char('r');
rplot(var_list_);
save('nk3_ex5b_results.mat', 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save('nk3_ex5b_results.mat', 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save('nk3_ex5b_results.mat', 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save('nk3_ex5b_results.mat', 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save('nk3_ex5b_results.mat', 'estimation_info', '-append');
end
if exist('dataset_info', 'var') == 1
  save('nk3_ex5b_results.mat', 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save('nk3_ex5b_results.mat', 'oo_recursive_', '-append');
end
