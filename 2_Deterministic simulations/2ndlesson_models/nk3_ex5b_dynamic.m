function [residual, g1, g2, g3] = nk3_ex5b_dynamic(y, x, params, steady_state, it_)
%
...
T18 = y(10)^(-params(1));
T22 = y(5)^(-params(1));
T63 = params(2)*log(y(2))+(1-params(2))*(log((steady_state(2))/params(5))+params(3)*log(y(1)/(steady_state(2)))+log(y(5)/(steady_state(1)))*params(4))+x(it_, 1);
...
T85 = 1/(steady_state(1))/(y(5)/(steady_state(1)));
  ...
  g1(2,8)=1/y(8);
  g1(3,5)=(-((1-params(2))*params(4)*T85*(1-(0>T63))));
  g1(3,1)=(-((1-(0>T63))*(1-params(2))*params(3)*1/(steady_state(2))/(y(1)/(steady_state(2)))));
  g1(3,2)=(-((1-(0>T63))*params(2)*1/y(2)));
  g1(3,7)=1/y(7);
  g1(3,13)=(-(1-(0>T63)));
