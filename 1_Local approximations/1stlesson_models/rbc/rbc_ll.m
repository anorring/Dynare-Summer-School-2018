...
M_.exo_names_long = 'e';
M_.endo_names = 'lC';
M_.endo_names_tex = 'lC';
M_.endo_names_long = 'lC';
...
M_.endo_names = char(M_.endo_names, 'lL');
M_.endo_names_tex = char(M_.endo_names_tex, 'lL');
M_.endo_names_long = char(M_.endo_names_long, 'lL');
...
erase_compiled_function('rbc_ll_static');
erase_compiled_function('rbc_ll_dynamic');
M_.orig_eq_nbr = 6;
M_.eq_nbr = 6;
M_.ramsey_eq_nbr = 0;
...
save('rbc_ll_results.mat', 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save('rbc_ll_results.mat', 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save('rbc_ll_results.mat', 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save('rbc_ll_results.mat', 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save('rbc_ll_results.mat', 'estimation_info', '-append');
end
if exist('dataset_info', 'var') == 1
  save('rbc_ll_results.mat', 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save('rbc_ll_results.mat', 'oo_recursive_', '-append');
end
