...
estim_params_.param_vals = [estim_params_.param_vals; 3, NaN, (-Inf), Inf, 5, NaN, NaN, 0, 100, NaN ];
options_gsa = struct();
...
if exist('dataset_info', 'var') == 1
  save('nk1_results.mat', 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save('nk1_results.mat', 'oo_recursive_', '-append');
end
